<div class="max-w-lg mx-auto p-4">
    ...
    <form wire:submit.prevent="save">
        <div class="mb-4">
            <label for="client_id" class="block text-sm font-medium text-gray-700" wire:dirty.class="text-red-400" wire:target="form.client_id">
                Client<span wire:dirty wire:target= "form.client_id">*</span>
            </label>
        ...
        <div class="mb-4">
            <label for="service_id" class="block text-sm font-medium text-gray-700" wire:dirty.class="text-red-400" wire:target="form.service_id">
                Service                <span wire:dirty wire:target= "form.service_id">*</span>
        ...
        <div class="mb-4">
            <label for="date_rdv" class="block text-sm font-medium text-gray-700" wire:dirty.class="text-red-400" wire:target="form.date_rdv">
                Date & Heure<span wire:dirty wire:target= "form.date_rdv">*</span>
        ...
        <div class="mb-4">
            <label for="status" class="block text-sm font-medium text-gray-700" wire:dirty.class="text-red-400" wire:target="form.status">
                Statut<span wire:dirty wire:target= "form.status">*</span>
            </label>
